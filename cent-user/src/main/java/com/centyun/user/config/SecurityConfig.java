package com.centyun.user.config;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private AuthenticationFailureHandler userAuthenticationFailHander;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.addFilterBefore(captchaAuthenticationFilter(), UsernamePasswordAuthenticationFilter.class).formLogin()
...
//              .failureHandler(userAuthenticationFailHander)
    ...
    public CaptchaAuthenticationFilter captchaAuthenticationFilter() throws Exception {
        ...
        authenticationFilter.setAuthenticationSuccessHandler(userAuthenticationSuccessHandler);
        authenticationFilter.setAuthenticationFailureHandler(userAuthenticationFailHander);
