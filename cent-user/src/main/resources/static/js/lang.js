...
user.login['zh_CN']={
	...
	mainUserCantEmpty : '主账号不能为空',
	mainUserPwdCantEmpty : '主账号密码不能为空',
	loginError: '登录出错',
	saveError: '保存出错',
	deleteError: '删除出错',
...
user.login['en_US']={
	...
	mainUserCantEmpty : 'Main User Cannot be Empty',
	mainUserPwdCantEmpty : 'Main User Password Cannot be Empty',
